...
<body class="flex items-center justify-center h-screen bg-gray-100">
  ...
  <form action="" method="POST" class="bg-white p-8 rounded shadow-md w-full max-w-sm space-y-4">
    ...
    <div class="relative">
      ...
      <svg id="togglePassword" xmlns="http://www.w3.org/2000/svg" class="absolute right-3 top-9 h-5 w-5 text-gray-400 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
