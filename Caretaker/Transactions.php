...
// Fetch tenants for the dropdown (only for the caretaker's property)
$tenantsQuery = "SELECT id, name, property, unit FROM users WHERE property = ?";
...
// Fetch transactions to display (only for the caretaker's property)
$transactionsQuery = "
